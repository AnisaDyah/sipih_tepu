...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Des 2019 pada 17.09
...
(8, 23, '2019-12-08', 300000, 'buktipembayaran.jpg', 'sudah di bayar'),
(9, 23, '2019-12-08', 3000, 'buktipembayaran1.jpg', 'sudah di kirim'),
(10, 23, '2019-12-08', 2000, NULL, 'belum di bayar'),
(11, 23, '2019-12-08', 1000, NULL, 'belum di bayar'),
(12, 23, '2019-12-08', 40000, NULL, 'belum di bayar'),
(13, 23, '2019-12-08', 10000, NULL, 'belum di bayar');
...
(9, 'Tshirt Bag', 'T-shirt-Bag-L1.png', 5, 200, 1000, 'Kami memiliki solusi alternatif untuk kantong plastik sekali pakai Anda yang berbahaya. Kami dapat membantu Anda membawa barang-barang Anda dan tampil seperti plastik biasa. Setiap tahun, diperkirakan 1 triliun kantong plastik dikonsumsi di seluruh dunia. Kompos dan dapat terurai secara hayati, kantong organik yang terbuat dari Singkong ini menawarkan solusi yang dapat disesuaikan untuk mengurangi sampah plastik. Tas ini adalah sebuah alternatif yang menjadi pengganti yang ideal untuk kantong plastik pada umumnya.'),
(10, 'Griphole Bag', 'Griphole-L-480x640.png', 5, 250, 2000, 'Kami juga memiliki jenis khusus tas organik yang biasanya ditujukan untuk mengemas pakaian / kain, kertas, aksesori, dll. Tas ini dapat di jadikan sebagai kompos, dengan cara pengomposan rumah yakni produk ini akan menjadi pupuk untuk tanaman Anda.'),
(12, 'Laundry / Garbage Bag', 'Laundry-or-Garbage-Bag-Large-480x6401.png', 5, 300, 2000, ' Terkadang sulit untuk mencari opsi berkelanjutan untuk menampung sampah Anda. Produk ini dibuat khusus untuk tempat sampah, kini Anda dapat membuang sampah tanpa harus menambahkan sampah plastik lain dengan menggunakan kantong ramah lingkungan seperti kami. Selain itu, Anda dapat membuat kompos sampah organik Anda tanpa membuat tangan Anda kotor karena kami juga kompos!'),
(13, 'Polybag', 'Polybag-Large-480x640.png', 5, 500, 1000, 'Tas adalah jenis khusus tas organik yang biasanya ditujukan untuk mengemas pakaian / kain, kertas, aksesori, dll. Tas ini juga dapat dijadikan kompos untuk tanaman Anda.'),
...
(15, 'Paper Wrapped Straw', 'Paper-Wrapped-Straw-480x640.png', 6, 470, 1000, 'Produk ini berasal dari bahan organik dan dilapisi dengan lilin nabati agar lebih tahan lama, menjadikan kami pilihan yang lebih berkelanjutan untuk dipilih.'),
(16, 'PLA Straw', 'PLA-straw-White-6-x-197-mm-480x640.png', 6, 700, 2000, 'Terbuat dari bahan poly lactic acid (PLA) atau yang biasa dikenal dengan tepung jagung, produk ini memiliki kualitas yang tinggi.'),
(17, 'Bio Poncho', 'Poncho-480x640.png', 8, 300, 20000, 'Produk ini yakni Jas Hujan Organik, yang terbuat dari bahan Organik yang dapat di daur ulang kembali/'),
(18, 'Bowl', 'Bagasse-Food-Bowl-7-inch-480x640.png', 7, 570, 10000, 'Dibuat sepenuhnya dari bahan Organik, menjadikan kami solusi alternatif terbaik untuk wadah makanan Anda. Cukup buang dengan mengubur kami dengan bahan organik lainnya dan kami akan menjadi tanah dalam beberapa bulan!'),
(19, 'Plate', 'Bagasse-Edge-Plate-9-inch-480x640.png', 7, 670, 10000, 'Produk ini dibuat sepenuhnya dari bahan Organik, menjadikan kami solusi alternatif terbaik untuk wadah makanan Anda. Cukup buang dengan mengubur kami dengan bahan organik lainnya dan kami akan menjadi tanah dalam beberapa bulan!'),
(21, 'Rectangle Food Box', 'Bagasse-Food-Box-600-ml-480x640.png', 7, 700, 15000, 'Produk ini dibuat sepenuhnya dari bahan Organik, menjadikan kami solusi alternatif terbaik untuk wadah makanan Anda. Cukup buang dengan mengubur kami dengan bahan organik lainnya dan kami akan menjadi tanah dalam beberapa bulan!'),
(22, 'Square Food Box', 'Bagasse-Food-Box-9-inch-480x640.png', 7, 530, 15000, 'Produk ini dibuat sepenuhnya dari bahan Organik, menjadikan kami solusi alternatif terbaik untuk wadah makanan Anda. Cukup buang dengan mengubur kami dengan bahan organik lainnya dan kami akan menjadi tanah dalam beberapa bulan!'),
(23, 'Cutlery', 'PLA-Cutlery-480x640.png', 9, 600, 10000, 'Produk ini terlihat, terasa seperti plastik, tetapi ternyata tidak! Terbuat dari Polylactic Acid (PLA) atau tepung jagung, kita bisa berubah menjadi kompos yang baik bagi lingkungan.'),
