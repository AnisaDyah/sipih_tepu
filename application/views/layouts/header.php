        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="<?php echo base_url()?>" data-animate-hover="bounce">
                    <img src="<?php echo base_url() ?>assets/img/logo0.jpeg" alt="HP logo" class="hidden-xs">
                    <img src="<?php echo base_url() ?>assets/img/logo-small.png" alt="HP logo" class="visible-xs"><span class="sr-only">SIPPKO  - go to homepage</span>
                </a>
                            ...
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <ul>
                                                <li><a href="<?php echo base_url()?>home/bag">Bag</a></li>
                                                <li><a href="<?php echo base_url()?>home/straw">Straw</a></li>
                                                <li><a href="<?php echo base_url()?>home/container">Container</a></li>
                                                <li><a href="<?php echo base_url()?>home/poncho">Poncho</a></li>
                                                <li><a href="<?php echo base_url()?>home/pla">PLA</a></li>
                                                <li><a href="<?php echo base_url()?>home/paper">Paper</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="navbar-buttons">
                ...
                <?php
                    ...
                    { ?>
                        <a href="#" data-toggle="modal" data-target="#login-modal" class="btn btn-primary navbar-btn" disabled><i class="fa fa-shopping-cart"></i><span class="hidden-sm">Cart</span></a>
                    <?php }
                    ?>
